...
def get_args():
    ...
    parser.add_argument('-emb_keep_prob',
                        type=float,
                        default=0.925,
                        help='Dropout keep prob for embedding layers')
    parser.add_argument('-keep_prob',
                        type=float,
                        default=0.7,
                        help='Dropout keep prob in rnn')
    ...
    parser.add_argument('-ques_limit',
                         type=int,
                        default=80)
    parser.add_argument('-opt_limit',
                        type=int,
                        default=80)
    #emb_keep_prob, keep_prob, para_limit, ques_limit,
